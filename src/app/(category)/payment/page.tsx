            ...
            <section className="p-4 sm:p-6 lg:p-8 border rounded-lg bg-white">
              ...
              <div>
               ...
               alt={"security"}         
                ...
                <p className="py-3 text-slate-500"> We are using the most advanced security to provide you the best experience ever.</p>
              </div>
              <Link href="/dashboard">
                <button className="w-[140px] p-3 mt-4 bg-blue-500 text-white rounded-md hover:bg-blue-700">
                  Rent Now
                </button>
              </Link>
            </section>
